let set11 =
    [
        {
            question: `#1. In India, crops are classified into two groups, on the basis of the season they grow-Rabi crops and Kharif crops. In the context of these crops, consider the following statements: \n 1. Kharif crops are sown in summer. \n 2. Rabi crops are grown in winter. \n Which of the statements given above is/are correct?`,
            options:
                ['A. 1 only',
                    'B. 2 only',
                    'C. Both 1 and 2',
        ...
        {
            question: `#3. Cod liver oil contains high amount of vitamin D. From which of the following animals, is cod liver oil obtained?`,
            options:
                ['A. Frog',
                    'B. Fish',
                    'C. Snake',
        ...
        {
            question: `#4. Which one of the following is a preservative used in preservation of fruits as jams and jellies?`,
            options:
                ['A. Mustard oil',
                    'B. Vinegar',
                    'C. Sugar',
        ...
        {
            question: `#6. Which one of the following crops does not require nitrogenous fertiliser?`,
            options:
                ['A. Wheat',
                    'B. Millet',
                    'C. Beans',
        ...
        {
            question: `#8. The process of loosening and turning the soil is called:`,
            options:
                ['A. Ploughing',
                    'B. Levelling',
                    'C. Manuring',
        ...
        {
            question: `#9. Which one among the following is a useful microorganism? \n 1. Salmonella typhi \n 2. Rhizobium \n 3. Lactobacillus \n 4. Rhinovirus`,
            options:
                ['A. 1 and 2',
                    'B. 2 and 3',
                    'C. 3 and 4',
        ...
        {
            question: `#10. Which leaves are used to protect stored grains from insects and microorganisms?`,
            options:
                ['A. Mango leaves',
                    'B. Peepal leaves',
                    'C. Banana leaves',
