...
'C. A is correct but R is not correct.',
    ...
    {
        question:`#5. Assertion A: Iron used to strengthen the bridges and automated vehicles, has a tendency to be easily corroded and rusting. \n Reasoning R: To prevent the corrosion and rusting, a layer of zinc is electroplated on iron. \n Select the correct answer from the options given below:`,
        options:
        [
'A. Both A and R are correct and R is the correct explanation for A.',
'B. Both A and R are correct but R is not the correct explanation of A.',
...
'C. Both 3 and 4',
    ...
    {
        question:`#8. What will be the effect of temperature on speed of sound?`,
        options:
        [
...
'C. The speed of sound increases with the decrease of temperature of the medium.',
    ...
    {
        question:`#9. A positive charge is moving towards a person. The direction of magnetic field lines will be in`,
        options:
        [
...
'C. Vertically upward direction',
    ...
    {
        question:`#10. What is the unit of loudness?`,
        options:
        [
'A. Bel',
'B. Phon',
