let set13 =
    [
        ...
        {
            question: `#3. Uniforms of firemen have a coating to make them flame resistant. Which of the following is used to make that coat?`,
            options:
                [
                    'A. Melamine',
                    'B. Bekalite',
        ...
        {
            question: `#4. Which of the following metals remains in liquid state at room temperature?`,
            options:
                [
                    'A. Sodium',
                    'B. Mercury',
        ...
        {
            question: `#5. If copper utensils are exposed to moist air for a long time, they develop a green layer over them. Which of the following is that green substance?`,
            options:
                [
                    'A. Copper Hydroxide',
                    'B. Copper Carbonate',
        ...
        {
            question: `#6. Which of the following is a highly reactive metal which catches fire when exposed to air?`,
            options:
                [
                    'A. Phosphorus',
                    'B. Sodium',
        ...
        {
            question: `#7. Name the synthetic polymer that resembles like natural rubber?`,
            options:
                [
                    'A. Polypropene',
                    'B. Neoprene',
        ...
        {
            question: `#8. Name the polymer that can have strong intermolecular forces?`,
            options:
                [
                    'A. Polyester',
                    'B. Teflon',
        ...
        {
            question: `#9. Aluminium is used for making cooking utensils. Which of the following properties of aluminium are responsible for the same? \n 1. Good thermal conductivity \n 2. Good electrical conductivity \n 3. Ductility \n 4. High melting point`,
            options:
                [
                    'A. 1 and 2',
                    'B. 1 and 3',
        ...
        {
            question: `#10. Which of the following represent the correct order of decreasing reactivity?`,
            options:
                [
                    'A. Mg > Al > Zn > Fe',
                    'B. Mg > Zn > Al > Fe',
