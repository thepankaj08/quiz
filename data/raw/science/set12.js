let set12 =
    [
        ...
        {
            question: `#3. Which of the following microorganisms is required to turn milk into curd?`,
            options:
                [
                    'A. Bacteria',
                    'B. Fungi',
        ...
        {
            question: `#4. Which of the following is produced by yeast through respiration, when it is mixed with food items?`,
            options:
                [
                    'A. Oxygen',
                    'B. Carbon dioxide',
        ...
        {
            question: `#7. Consider the following pairs: Plant disease Causative microorganism \n 1. Lemon canker Bacteria \n 2. Rust of wheat Fungi \n 3. Yellowing of ladyfinger Virus \n Which of the pairs given above is/are correctly matched?`,
            options:
                [
                    'A. 1 only',
                    'B. 2 only',
        ...
        {
            question: `#10. Which of the following statements is not correct, in regard to nitrogen cycle?`,
            options:
                [
